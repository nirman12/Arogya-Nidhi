...
const TRIAGE_RULES = [
  {
    specialty: 'General',
    keywords: [
      'diabetes', 'type 2', 'type ii', 'blood sugar', 'high blood sugar', 'glucose', 'hyperglycemia', 'hypoglycemia', 'insulin',
      'fever', 'cold', 'flu', 'infection', 'viral', 'bacterial', 'cough', 'runny nose', 'sneezing', 'sore', 'body ache',
      'weakness', 'fatigue', 'tired', 'general malaise', 'common cold', 'chills', 'aches', 'body pain',
      'hypertension', 'high blood pressure', 'low blood pressure', 'blood pressure', 'anemia', 'low iron',
      'allergies', 'allergy', 'food allergy', 'allergic reaction', 'hay fever', 'runny', 'sneezing',
      'weight gain', 'weight loss', 'obesity', 'overweight', 'underweight', 'thyroid',
      'general check up', 'wellness', 'preventive', 'vaccination', 'immunization', 'checkup', 'annual physical',
    ],
    causeHint: 'General health concerns can be triggered by various factors including infections, lifestyle, stress, or underlying conditions.',
    urgencyLevel: 'medium',
    confidenceScore: 0.78,
    aiReasoning: 'Common health concerns, infections, and general symptoms are best assessed first by a general physician.',
  },
  {
    specialty: 'Cardiology',
    keywords: [
      'heart pain', 'heart ache', 'chest pain', 'chest ache', 'chest tightness', 'chest discomfort', 'chest pressure',
      'palpitation', 'palpitations', 'irregular heartbeat', 'heart pounding', 'heart racing', 'heart flutter',
      'shortness of breath', 'breathless', 'difficulty breathing', 'breathlessness', 'dyspnea', 'winded',
      'left chest', 'chest', 'cardiac', 'heart', 'cardiovascular', 'heart disease',
      'arrhythmia', 'atrial fibrillation', 'afib', 'tachycardia', 'bradycardia',
      'heart attack', 'mi', 'myocardial infarction', 'angina', 'heart condition', 'heart problem',
      'hypertension', 'high blood pressure', 'low blood pressure', 'blood pressure problem',
      'edema', 'swelling', 'fluid retention', 'swollen legs', 'swollen feet', 'edematous',
      'syncope', 'fainting', 'faint', 'lightheaded', 'dizziness', 'giddiness',
      'cholesterol', 'high cholesterol', 'lipid', 'triglycerides',
    ],
    causeHint: 'Possible reasons include acidity, muscle strain, anxiety, arrhythmia, or reduced blood flow to the heart.',
    urgencyLevel: 'high',
    confidenceScore: 0.92,
    aiReasoning: 'Chest discomfort, palpitations, shortness of breath, or irregular heartbeat can indicate a cardiac concern requiring cardiology review.',
  },
  {
    specialty: 'Neurology',
    keywords: [
      'headache', 'head ache', 'pain in head', 'migraine', 'migraines', 'severe headache', 'chronic headache', 'tension headache',
      'dizziness', 'dizzy', 'lightheaded', 'vertigo', 'spinning', 'balance problem', 'loss of balance',
      'seizure', 'seizures', 'convulsion', 'fitting', 'epilepsy', 'epileptic', 'blackout',
      'numbness', 'numb', 'paresthesia', 'tingling', 'pins and needles', 'prickling', 'burning sensation',
      'weakness', 'weak', 'paralysis', 'paresis', 'limp', 'dragging leg', 'weak arm',
      'memory loss', 'memory problem', 'forgetfulness', 'confusion', 'confused', 'disorientation',
      'tremor', 'shaking', 'trembling', 'tremulous', 'shakiness',
      'stroke', 'tia', 'transient ischemic attack', 'brain', 'neurological',
      'nerve pain', 'neuropathy', 'sciatica', 'nerve damage', 'pinched nerve', 'nerve compression',
      'brain fog', 'concentration problem', 'difficulty focusing', 'attention problem',
      'loss of consciousness', 'fainting', 'blackout', 'coma',
    ],
    causeHint: 'Possible reasons include migraine, nerve irritation, inner-ear imbalance, stroke, or other neurological causes.',
    urgencyLevel: 'medium',
    confidenceScore: 0.86,
    aiReasoning: 'Headache, dizziness, seizures, numbness, weakness, or memory symptoms point toward a neurological evaluation.',
  },
  {
    specialty: 'Dermatology',
    keywords: [
      'rash', 'rashes', 'skin rash', 'itching', 'itching skin', 'itchy', 'itchy skin', 'scratch', 'scratching',
      'acne', 'pimple', 'pimples', 'zit', 'blackhead', 'whitehead', 'spots', 'breakout',
      'eczema', 'dermatitis', 'contact dermatitis', 'atopic eczema',
      'psoriasis', 'scaling', 'scaly skin', 'flaky', 'flaking skin',
      'skin infection', 'fungal', 'fungal infection', 'ringworm', 'tinea', 'candida', 'bacterial infection',
      'hair fall', 'hair loss', 'alopecia', 'baldness', 'thinning hair', 'dandruff',
      'hives', 'urticaria', 'welts', 'allergic rash',
      'moles', 'mole', 'nevus', 'birthmark', 'dark spot', 'skin lesion',
      'warts', 'wart', 'verruca', 'skin tag',
      'boils', 'boil', 'abscess', 'pus', 'infection', 'furuncle',
      'sores', 'sore', 'wounds', 'ulcers', 'cold sore', 'blister',
      'dry skin', 'oily skin', 'sensitive skin', 'combination skin',
      'sunburn', 'burns', 'chemical burn', 'wound', 'cut', 'laceration',
      'aging skin', 'wrinkles', 'lines', 'anti-aging', 'skin rejuvenation',
    ],
    causeHint: 'Possible reasons include allergy, infection, dermatitis, fungus, or inflammatory skin conditions.',
    urgencyLevel: 'low',
    confidenceScore: 0.84,
    aiReasoning: 'Skin rash, itching, acne, eczema, psoriasis, infections, or hair problems are best assessed by dermatology.',
  },
  {
    specialty: 'Orthopedics',
    keywords: [
      'joint pain', 'joint ache', 'knee pain', 'knee ache', 'back pain', 'backache', 'lower back pain', 'upper back pain',
      'neck pain', 'neck ache', 'cervical pain', 'shoulder pain', 'shoulder ache', 'shoulder blade',
      'hip pain', 'hip ache', 'ankle pain', 'ankle ache', 'elbow pain', 'wrist pain', 'hand pain',
      'fracture', 'broken bone', 'break', 'crack', 'sprain', 'strain', 'pull', 'torn', 'tear',
      'bone pain', 'bone ache', 'skeletal pain',
      'arthritis', 'osteoarthritis', 'rheumatoid arthritis', 'ra', 'gout', 'joint disease',
      'inflammation', 'inflamed', 'swelling', 'swollen', 'edema', 'puffy',
      'stiffness', 'stiff', 'limited mobility', 'reduced range of motion', 'range of motion',
      'tendinitis', 'tendon pain', 'tendon inflammation', 'bursitis', 'bursa',
      'ligament', 'ligament damage', 'ligament tear', 'acl', 'mcl', 'lcl', 'pcl',
      'cartilage', 'cartilage damage', 'meniscus', 'meniscal tear',
      'disc', 'disc herniation', 'slipped disc', 'disc bulge', 'disc protrusion', 'vertebra',
      'sciatica', 'sciatic nerve', 'nerve compression', 'pinched nerve',
      'muscle strain', 'muscle pull', 'muscle injury', 'pulled muscle', 'muscle pain',
      'dislocation', 'dislocated', 'subluxation', 'joint displacement',
      'lameness', 'limping', 'gait problem', 'unable to walk', 'difficulty walking',
    ],
    causeHint: 'Possible reasons include ligament strain, arthritis, disc issues, tendon inflammation, or bone and joint injury.',
    urgencyLevel: 'medium',
    confidenceScore: 0.82,
    aiReasoning: 'Joint pain, back pain, fractures, sprains, arthritis, or musculoskeletal injuries require orthopedic evaluation.',
  },
  {
    specialty: 'Pediatrics',
    keywords: [
      'my child', 'my baby', 'my son', 'my daughter', 'child has', 'baby has', 'son has', 'daughter has',
      'infant', 'toddler', 'newborn', 'kid', 'kids', 'children', 'pediatric',
      'child fever', 'baby fever', 'infant fever', 'fever in child', 'high fever', 'low grade fever',
      'baby cough', 'child cough', 'infantile cough', 'cough', 'whooping cough', 'croup',
      'diaper rash', 'nappy rash', 'diaper dermatitis',
      'teething', 'teething pain', 'sore gums', 'drooling',
      'colic', 'colicky', 'excessive crying', 'abdominal pain in child',
      'vaccination', 'vaccine', 'immunization', 'shot', 'jab', 'dpt', 'mmr', 'polio',
      'growth', 'growth chart', 'growth concern', 'not growing', 'short stature', 'tall', 'growth delay',
      'development', 'developmental milestone', 'developmental delay', 'development concern',
      'asthma in child', 'childhood asthma', 'wheezing', 'asthmatic',
      'allergies in child', 'child allergy', 'food allergy', 'allergic reaction',
      'ear infection', 'otitis', 'ear pain in child', 'child earache',
      'respiratory infection', 'uri', 'upper respiratory', 'lower respiratory',
      'measles', 'chickenpox', 'varicella', 'mumps', 'rubella', 'scarlet fever',
      'diarrhea in child', 'constipation in child', 'vomiting', 'nausea',
      'rash in child', 'childhood rash', 'eczema', 'diaper rash',
    ],
    causeHint: 'Possible reasons vary by age and symptom, including viral infections, common pediatric illnesses, or developmental concerns.',
    urgencyLevel: 'medium',
    confidenceScore: 0.8,
    aiReasoning: 'Symptoms described for a child, baby, or infant should be reviewed by a pediatrician for age-appropriate assessment.',
  },
];
...
const EXTERNAL_FIELD_RULES = [
  {
    ...
    keywords: [
      'abdominal pain', 'stomach pain', 'stomach ache', 'stomach', 'abdomen', 'vomit', 'vomiting', 'nausea', 'diarrhea', 'constipation',
      'reflux', 'acidity', 'acid reflux', 'gerd', 'heartburn', 'indigestion', 'bloating', 'bloated', 'gas', 'flatulence',
      'blood in stool', 'bloody stool', 'ulcer', 'gastric', 'intestinal', 'bowel', 'intestine', 'dysphagia', 'difficulty swallowing',
      'liver pain', 'liver', 'pancreas', 'pancreatic', 'ibs', 'irritable bowel', 'colitis', 'crohn', 'celiac', 'gluten',
    ],
    reason: 'digestive, stomach, intestinal, or gastrointestinal symptoms are usually assessed by gastroenterology.',
  },
  {
    field: 'Gynecology',
    keywords: [
      'period', 'periods', 'menstrual', 'menstruation', 'missed period', 'late period', 'pregnant', 'pregnancy', 'prenatal',
      'pelvic pain', 'pelvic', 'vaginal discharge', 'vaginal bleeding', 'abnormal bleeding', 'bleeding', 'uterus', 'uterine', 'ovary', 'ovarian',
      'breast pain', 'breast tenderness', 'breast', 'nipple', 'hormonal', 'hormone', 'fertility', 'infertility', 'menopause',
      'cyst', 'ovarian cyst', 'fibroids', 'endometriosis', 'polycystic', 'amenorrhea', 'dysmenorrhea', 'pms', 'hormonal imbalance',
    ],
    reason: 'menstrual, pregnancy, reproductive, breast, or hormonal-health symptoms are usually assessed by gynecology.',
  },
  {
    field: 'ENT (Ear, Nose, Throat)',
    keywords: [
      'ear pain', 'earache', 'otalgia', 'hearing loss', 'tinnitus', 'ringing ears', 'ringing', 'tonsil', 'tonsillitis', 'sore throat',
      'throat pain', 'throat', 'sinus', 'sinusitis', 'sinus pain', 'blocked nose', 'nasal congestion', 'runny nose', 'nose bleed', 'epistaxis',
      'laryngitis', 'hoarse', 'hoarseness', 'voice loss', 'voice change', 'nasal polyp', 'polyp', 'deviated septum', 'nasal',
      'ear infection', 'otitis', 'swollen glands', 'lymph nodes', 'glands', 'upper respiratory', 'vocal cord',
    ],
    reason: 'ear, nose, throat, sinus, and upper-respiratory symptoms are usually assessed by ENT.',
  },
  {
    field: 'Ophthalmology (Eye)',
    keywords: [
      'eye pain', 'eye', 'eyes', 'blurred vision', 'blurry', 'vision loss', 'red eye', 'redness', 'itchy eye', 'itchy eyes', 'watery eyes',
      'myopia', 'hyperopia', 'astigmatism', 'nearsighted', 'farsighted', 'presbyopia', 'dry eye', 'floaters', 'flashing lights',
      'glaucoma', 'cataract', 'stye', 'chalazion', 'conjunctivitis', 'pink eye', 'glasses', 'contact lens', 'prescription',
      'light sensitivity', 'photophobia', 'color blindness', 'vision problem', 'eyesight',
    ],
    reason: 'eye, vision, and sight-related symptoms are usually assessed by an ophthalmologist (eye specialist).',
  },
  {
    field: 'Psychiatry / Mental health',
    keywords: [
      'panic', 'panic attack', 'anxiety', 'anxious', 'depression', 'depressed', 'insomnia', 'sleep problem', 'can\'t sleep', 'sleepless',
      'suicidal', 'self harm', 'self injury', 'stressed', 'stress', 'emotional', 'bipolar', 'mood swings', 'ocd', 'obsessive compulsive',
      'ptsd', 'trauma', 'eating disorder', 'anorexia', 'bulimia', 'addiction', 'obsessive', 'phobia', 'paranoia', 'paranoid',
      'delusion', 'hallucination', 'schizophrenia', 'psychosis', 'loneliness', 'grief', 'loss', 'anger management', 'irritability',
    ],
    reason: 'mood, mental health, sleep, anxiety, stress, and psychological symptoms are usually assessed by mental health specialists.',
  },
  {
    field: 'Urology',
    keywords: [
      'burning urination', 'burning when urinate', 'painful urination', 'dysuria', 'urination', 'urine', 'frequent urination', 'urgency',
      'blood in urine', 'hematuria', 'kidney stone', 'stone', 'prostate', 'prostatic', 'urinary incontinence', 'incontinence',
      'erectile dysfunction', 'impotence', 'ed', 'testicular pain', 'testicular', 'testicle', 'penile', 'penis', 'cystitis',
      'uti', 'urinary tract infection', 'bladder', 'bladder pain', 'kidney', 'kidney pain', 'hydrocele', 'varicocele', 'epididymitis',
    ],
    reason: 'urinary, kidney, bladder, and reproductive-system symptoms are usually assessed by urology.',
  },
  {
    field: 'Endocrinology',
    keywords: [
      'thyroid', 'thyroid problem', 'hypothyroid', 'hyperthyroid', 'thyroiditis', 'hormone', 'hormonal', 'pcos', 'polycystic ovary',
      'weight gain', 'weight loss', 'unexplained weight', 'fatigue', 'tired', 'metabolic', 'metabolism', 'slow metabolism',
      'growth problem', 'growth disorder', 'dwarfism', 'tall', 'short stature', 'puberty', 'delayed puberty', 'precocious puberty',
      'adrenal', 'cortisol', 'goiter', 'iodine', 'nodule', 'swollen thyroid', 'temperature sensitivity', 'heat intolerance', 'cold intolerance',
    ],
    reason: 'hormone, thyroid, metabolic, and endocrine-system symptoms are usually assessed by endocrinology.',
  },
];
